...
public:
    ...
    TableSection *pageTable;
    QWidget *page_3;
    QGridLayout *gridLayout_3;
    QuizSection *pageQuiz;
...
"  ==================================================== */"));
        ...
        btnQuiz->setLayoutDirection(Qt::RightToLeft);
        btnQuiz->setStyleSheet(QString::fromUtf8("text-align: center;"));
        ...
        btnTable->setLayoutDirection(Qt::RightToLeft);
        btnTable->setStyleSheet(QString::fromUtf8("text-align: center;"));
        ...
        pageTable = new TableSection(page_1);
        pageTable->setObjectName("pageTable");

        gridLayout_2->addWidget(pageTable, 0, 0, 1, 1);
        ...
        pageQuiz = new QuizSection(page_3);
        pageQuiz->setObjectName("pageQuiz");

        gridLayout_3->addWidget(pageQuiz, 0, 0, 1, 1);
